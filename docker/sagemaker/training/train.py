"""
Healthcare Imaging MLOps Platform - Training Script
ResNet-50 based pneumonia detection model training for SageMaker
"""
...
if __name__ == "__main__":
    ...
    save_training_metrics(history.history, args.model_dir)
